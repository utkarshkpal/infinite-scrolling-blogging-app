...
describe('reducer', function () {
  ...
  it('should push a deep array value which is a nested object', function () {
    ...
    }, _extends({}, _actions.addArrayValue('myField', {
  ...
  describe('reducer.normalize', function () {
    it('should initialize form state when there is a normalizer', function () {
      ...
      _expect2['default'](state.foo).toExist().toBeA('object').toEqual((_expect$toExist$toBeA$toEqual3 = {
        ...
        value: 'normalized'
      }, _expect$toExist$toBeA$toEqual3.person = {
        name: {
          value: 'John Doe'
        }
      }, _expect$toExist$toBeA$toEqual3.pets = [], _expect$toExist$toBeA$toEqual3));
    });
    ...
    it('should allow resetForm to work on a normalized form', function () {
      ...
      _expect2['default'](result).toExist().toBeA('object');
      _expect2['default'](result.foo).toExist().toBeA('object').toEqual(_extends({}, defaultFields, {
        name: {
          value: undefined
        },
        person: {
    ...
    it('should normalize arbitrarily deeply nested fields', function () {
      ...
      var state = normalize({
        foo: {
          person: {
            name: _fieldValue.makeFieldValue({ value: 'John Doe' })
          },
          pets: [{ name: _fieldValue.makeFieldValue({ value: 'Fido' }) }, { name: _fieldValue.makeFieldValue({ value: 'Tucker' }) }],
          cats: [_fieldValue.makeFieldValue({ value: 'lion' }), _fieldValue.makeFieldValue({ value: 'panther' }), _fieldValue.makeFieldValue({ value: 'garfield' }), _fieldValue.makeFieldValue({ value: 'whiskers' })],
          programming: [{
            langs: [_fieldValue.makeFieldValue({ value: 'ml' }), _fieldValue.makeFieldValue({ value: 'ocaml' }), _fieldValue.makeFieldValue({ value: 'lisp' }), _fieldValue.makeFieldValue({ value: 'haskell' }), _fieldValue.makeFieldValue({ value: 'f#' })]
          }, {
            langs: [_fieldValue.makeFieldValue({ value: 'smalltalk' }), _fieldValue.makeFieldValue({ value: 'ruby' }), _fieldValue.makeFieldValue({ value: 'java' }), _fieldValue.makeFieldValue({ value: 'c#' }), _fieldValue.makeFieldValue({ value: 'c++' })]
          }],
          some: {
            numbers: [_fieldValue.makeFieldValue({ value: 1 }), _fieldValue.makeFieldValue({ value: 2 }), _fieldValue.makeFieldValue({ value: 3 }), _fieldValue.makeFieldValue({ value: 4 }), _fieldValue.makeFieldValue({ value: 5 }), _fieldValue.makeFieldValue({ value: 6 }), _fieldValue.makeFieldValue({ value: 7 }), _fieldValue.makeFieldValue({ value: 8 }), _fieldValue.makeFieldValue({ value: 9 }), _fieldValue.makeFieldValue({ value: 10 })]
          },
          a: {
            very: {
              deep: {
                object: {
                  property: _fieldValue.makeFieldValue({ value: 'test' })
                }
              }
            }
          },
          my: [{
            deeply: [{
              nested: {
                item: _fieldValue.makeFieldValue({ value: 'hello' }),
                not: _fieldValue.makeFieldValue({ value: 'lost' })
              },
              otherKey: _fieldValue.makeFieldValue({ value: 'Goodbye' })
            }, {
              nested: {
                item: _fieldValue.makeFieldValue({ value: 'hola' }),
                not: _fieldValue.makeFieldValue({ value: 'lost' })
              },
              otherKey: _fieldValue.makeFieldValue({ value: 'Adios' })
            }],
            stays: _fieldValue.makeFieldValue({ value: 'intact' })
          }, {
            deeply: [{
              nested: {
                item: _fieldValue.makeFieldValue({ value: 'world' }),
                not: _fieldValue.makeFieldValue({ value: 'lost' })
              },
              otherKey: _fieldValue.makeFieldValue({ value: 'Later' })
            }, {
              nested: {
                item: _fieldValue.makeFieldValue({ value: 'mundo' }),
                not: _fieldValue.makeFieldValue({ value: 'lost' })
              },
              otherKey: _fieldValue.makeFieldValue({ value: 'Hasta luego' })
            }],
            stays: _fieldValue.makeFieldValue({ value: 'intact' })
          }]
        }
      ...
      _expect2['default'](_fieldValue.isFieldValue(state.foo.name)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.person.name)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.pets[0].name)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.pets[1].name)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.cats[0])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.cats[1])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.cats[2])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.cats[3])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[0].langs[0])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[0].langs[1])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[0].langs[2])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[0].langs[3])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[0].langs[4])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[1].langs[0])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[1].langs[1])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[1].langs[2])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[1].langs[3])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.programming[1].langs[4])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.some.numbers[0])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.some.numbers[1])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.some.numbers[2])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.some.numbers[3])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.some.numbers[4])).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.a.very.deep.object.property)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[0].nested.item)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[0].nested.not)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[0].otherKey)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[1].nested.item)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[1].nested.not)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].deeply[1].otherKey)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[0].stays)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[0].nested.item)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[0].nested.not)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[0].otherKey)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[1].nested.item)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[1].nested.not)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].deeply[1].otherKey)).toBe(true);
      _expect2['default'](_fieldValue.isFieldValue(state.foo.my[1].stays)).toBe(true);
    });
  });
});