...
describe('readField', function () {
  ...
  it('should update a nested field', function () {
    ...
    _expect2['default'](beforeFoo).toNotBe(afterFoo); // field container instance should be same
    _expect2['default'](beforeField).toNotBe(afterField); // field instance should be different
  });
  ...
  it('should allow an array field to add a deeply nested value', function () {
    ...
    fields.foo.addField('rabbit');
    _expect2['default'](spy).toHaveBeenCalled().toHaveBeenCalledWith('foo', 'rabbit', undefined, ['bar[].baz']);
  });
