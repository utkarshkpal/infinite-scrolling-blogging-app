...
describe('createReduxForm', function () {
  ...
  it('should only rerender the form that changed', function () {
    ...
    var FooForm = (function (_Component8) {
      _inherits(FooForm, _Component8);
    ...
    var BarForm = (function (_Component9) {
      _inherits(BarForm, _Component9);
  ...
  it('should only rerender the field components that change', function () {
    ...
    var FooInput = (function (_Component10) {
      _inherits(FooInput, _Component10);
    ...
    var BarInput = (function (_Component11) {
      _inherits(BarInput, _Component11);
    ...
    var FieldTestForm = (function (_Component12) {
      _inherits(FieldTestForm, _Component12);
